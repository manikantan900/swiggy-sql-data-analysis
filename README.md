...
├── results/
│   ├── top_cities.png
│   └── restaurant_ranking.png
│
├── docs/
│   └── Swiggy_Business_Requirement_Document.pdf
│
└── README.md
...
Identified high-revenue cities contributing the majority of sales
...
Review outputs or screenshots in the results/ folder
